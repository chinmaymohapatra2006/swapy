  ...
  return (
    <div className="bg-black min-h-screen text-white font-body selection:bg-white/20">
      ...
      <nav className="fixed top-4 left-0 right-0 z-50 max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <a href="/profile" className="bg-white text-black rounded-full px-5 py-2.5 text-sm font-medium flex items-center gap-2 hover:bg-white/90 transition-colors">
      ...
      <section id="home" className="relative w-full h-[1000px] overflow-hidden flex flex-col items-center pt-[150px]">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-5xl mx-auto">
          ...
          >
            <a href="/profile" className="liquid-glass-strong rounded-full px-8 py-4 text-sm font-medium flex items-center gap-2 hover:bg-white/10 transition-colors">
               Get Started <ArrowUpRight className="w-4 h-4" />
            </a>
      ...
      <section id="how" className="relative w-full py-32 px-6 md:px-16 lg:px-24 flex flex-col items-center justify-center min-h-[700px] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto min-h-[500px] justify-center">
          ...
          <a href="/profile" className="liquid-glass-strong rounded-full px-6 py-3 text-sm font-medium flex items-center gap-2 hover:bg-white/10 transition-colors">
            Get Started <ArrowUpRight className="w-4 h-4" />
          </a>
        </div>
      </section>
      ...
      <section id="community" className="py-24 px-6 md:px-16 lg:px-24 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { quote: "A complete skill upgrade in five weeks. I taught React and learned advanced Python. Pure magic.", name: "Sarah Chen", role: "Software Engineer" },
            { quote: "Language fluency up 4x. The AI matched me with a native speaker who wanted my UX skills in return.", name: "Marcus Webb", role: "Product Designer" },
            { quote: "They didn't just teach me a frameowrk... they completely rebuilt my confidence in programming.", name: "Elena Voss", role: "Creative Director" }
          ].map((item, i) => (
