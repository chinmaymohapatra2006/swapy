...
const MATCHES = [
  { id: 1, name: 'Alice Chen', role: 'UI/UX Designer', rating: 4.9, match: '98%', teaching: ['Figma', 'CSS'], learning: ['React', 'Next.js'], avatar: '/photos/profile female 2.webp' },
  { id: 2, name: 'Marcus Fox', role: 'Backend Engineer', rating: 5.0, match: '94%', teaching: ['Node.js', 'Python'], learning: ['UI Design', 'Figma'], avatar: '/photos/profile male 1.avif' },
  { id: 3, name: 'Sarah Jin', role: 'Data Scientist', rating: 4.7, match: '89%', teaching: ['Python', 'SQL'], learning: ['Frontend', 'Tailwind'], avatar: '/photos/profile female 3.png' },
];
