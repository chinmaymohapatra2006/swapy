...
import { Home, User, MessageCircle, BarChart3, Settings, Zap, ArrowUpRight, Sun, Moon } from 'lucide-react';
    ...
    <div className="bg-black min-h-screen text-white font-body selection:bg-white/20 flex">
      ...
      <aside className="w-64 border-r border-white/5 h-screen sticky top-0 flex flex-col p-6">
        ...
        <nav className="flex flex-col gap-2 flex-1">
          ...
          <Link to="/profile" className="flex items-center gap-3 px-4 py-3 rounded-xl text-white bg-white/10 transition-all text-sm">
            <User className="w-4 h-4" /> My Profile
          </Link>
          <Link to="/matches" className="flex items-center gap-3 px-4 py-3 rounded-xl text-white/50 hover:text-white hover:bg-white/5 transition-all text-sm">
            <Zap className="w-4 h-4" /> Matches
          </Link>
          <Link to="/messenger" className="flex items-center gap-3 px-4 py-3 rounded-xl text-white/50 hover:text-white hover:bg-white/5 transition-all text-sm relative">
            <MessageCircle className="w-4 h-4" /> Messages
            <span className="absolute right-4 w-2 h-2 rounded-full bg-white"></span>
          </Link>
          <Link to="/requests" className="flex items-center gap-3 px-4 py-3 rounded-xl text-white/50 hover:text-white hover:bg-white/5 transition-all text-sm">
